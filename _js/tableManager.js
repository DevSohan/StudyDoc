	...
	$.fn.tablemanager = function (options = null) {
		...
		if (options !== null) {
            ...
            **/
			...
			if (
				...
				// div num rows
				var numrowsDiv =
					'<div id="for_numrows" class="for_numrows ' + tableid +'" style="display: inline;"><label for="numrows">' +
					translate(voc_show_rows) +
					': </label><select id="numrows" class="' + tableid +'"></select></div>';
				...
				$('select.'+tableid+'').on("change", function () {
        ...
        **/
		...
		function multicheck(){
			...
			$('.multidelete').attr('data-delete',[]);
			$('.multiexport').attr('data-export',[]);
			...
			$("#selectAll").click(function(){
				if(this.checked){
					...
					$('.multidelete').attr('data-delete',ids);
					$('.multiexport').attr('data-export',ids);
				} else{
					checkbox.each(function(){
						this.checked = false;
					});
			...
			checkbox.click(function(){
				if(!this.checked){
					$("#selectAll").prop("checked", false);
					ids = arrayRemove(ids, $(this).attr("data-id"));
					console.log(ids);
					$('.multidelete').attr('data-delete',ids);
					$('.multiexport').attr('data-export',ids);
				}else{
